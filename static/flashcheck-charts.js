...
function createPerformanceChart() {
    ...
    const data = [
        { model: 'Nehme-FlashCheck-1B', size: 1, average: 81.9, custom: true },
        { model: 'Nehme-FlashCheck-270M', size: 0.27, average: 75.5, custom: true },
...
function createDominanceChart() {
    ...
    const data = [
        { model: 'Nehme-FlashCheck-1B', average: 81.9, custom: true },
        ...
        { model: 'Nehme-FlashCheck-270M', average: 75.5, custom: true },
